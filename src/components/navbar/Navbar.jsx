  ...
  return (
    <div className="bg-white sticky top-0 z-50  "  >
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-green-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'bg-green-600' : '', color: mode === 'dark' ? 'white' : '', }}>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    ...
                    <span className="ml- text-sm font-medium text-gray-700 group-" style={{ color: mode === 'dark' ? 'white' : '', }}>0</span>
